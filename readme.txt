...
‫این متن نتیجه‌ی ترجمه‌ی آزاد و غیر دقیق متن اصلی این استاندارد که در آدرس ‫‪https://www.python.org/dev/peps/pep-0008‬ قرار داره‬ هست. بعضی قسمت‌ها حذف شده یا  توضیحاتی اضافه شده.
میزان پیشرفت کار طبق لیست مطالب سنجیده می‌شه و از قرار زیر هست:
Progress:
